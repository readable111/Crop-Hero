        ...
        <View style={{height: 100, width: '100%', alignItems: 'center'}}>
            ...
            <View style={styles.btnGridContainer}>
                <Row height={35}>
                        ...
                        <Col relativeColsCovered={4} alignItems='center'>
                            <AppButton title="" mci={notebookSelected ? "notebook-edit" : "notebook-edit-outline"} mciSize={30} mciColor={notebookSelected ? Colors.MALACHITE : Colors.SOFT_GREEN} onPress={() => Alert.alert('Test')}/>
                        </Col>
                        <Col relativeColsCovered={4} alignItems='center'>
