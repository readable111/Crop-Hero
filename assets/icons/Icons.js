...
const icons = {
    ...
    credit_card_black: require('./credit-card-black.png'),
    ...
    thermometer_santa_gray: require('./thermometer_santa_gray.png'),
    humidity_santa_gray: require('./humidity_santa_gray.png'),
};
